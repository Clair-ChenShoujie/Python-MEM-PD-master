...
a=np.loadtxt("E:/数学/数模/Python-MEM-PD-master/12第12章  回归分析/Pdata12_3.txt")
...
""" 
如果你希望生成一组在 0.001 到 1 之间的数值
那么可以将第一个参数设置为 -3（因为 10 的 -3 次方等于 0.001）
将第二个参数设置为 0（因为 10 的 0 次方等于 1）
 """
for k in kk:
...
#md0=Ridge(0.4).fit(x,y)  #构建并拟合模型(手动)
