...
import pylab as plt
L=[(1,2,8),(1,3,4),(1,5,2),(2,3,4),(3,4,2),(3,5,1),(4,5,5)]#dot,dot,edge
b=nx.Graph()
b.add_nodes_from(range(1,6))#点的个数5
b.add_weighted_edges_from(L)
T=nx.minimum_spanning_tree(b,'weight','kruskal')  #返回可迭代对象，参数(G,weight='weight',algorithm='kruskal')算法取值'kruskal''prim''boruvka'
